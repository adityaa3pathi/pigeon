...
export type Icon = keyof typeof Icons //converts this Icon function into a literal so that it can be passed as prop later cause functions can't be passed down as props