...
const FriendRequests: FC<FriendRequestsProps> = ({
    ...
    const acceptFriend = async (senderId: string) => {
            ...
            setFriendRequests((prev) => prev.filter((request) => request.senderId !== senderId)) //will remove the current request that you are working with 
            // filter function returns the new array which also happpens to be the updated state of our state variable
